...
render_line "$FB$FF" "$W_DOTS"  "OS"       "$OS_NAME"
render_line "$NB"    "$W_SOLID" "Kernel"   "$KERNEL"
render_line "$NB"    "$W_SOLID" "Uptime"   "$UPTIME_STR"
render_line "$FB$FF" "$W_SOLID" "Shell"    "$SHELL_NAME"
render_line "$SB$SF" "$W_DOTS"  "Packages" "$PKG_COUNT"
render_line "$FB$FF" "$W_SOLID" "Project"  "Avie CLI"
render_line "$NB"    "$W_SOLID" "Rank"     "Sqn Ldr"
render_line "$NB"    "$W_SOLID" "Status"   "Operational"
render_line "$FB$FF" "$W_DOTS"  "" ""
render_line "$FB$FF" "$W_DOTS"  "" ""
